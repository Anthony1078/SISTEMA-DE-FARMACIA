...
<head>
    ...
    <title>Sistema de Farmacia - Actualización de Medicamentos </title>
</head>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                SISTEMA DE FARMACIA - ACTUALIZACIÓN DE MEDICAMENTOS
            </h1>
        </section>
        ...
        <section class="content">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">Datos del Medicamento</div>
                ...
                <form action="controller_update_medicamentos.php" method="get">
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre_generico" value=" <?php echo $nombre_generico;?> ">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#myModal_laboratorio">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="precio_costo_real_caja" value=" <?php echo $precio_costo_real_caja;?> ">
                            </div>
                        </div>
                        <div class="col-md-2">
                        <div class="form-group">
                                <label>Precio Real/Unidad</label>
                                <input type="text" class="form-control"  name="precio_costo_real_unitario" value=" <?php echo $precio_costo_real_unitario;?> ">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="precio_costo_venta_caja" value=" <?php echo $precio_costo_venta_caja;?> ">
                            </div>
                        </div>
                        <div class="col-md-2">
                        <div class="form-group">
                                <label>Precio Venta/Unidad</label>
                                <input type="text" class="form-control" name="precio_costo_venta_unitario" value=" <?php echo $precio_costo_venta_unitario;?> " > 
                            </div>
                        </div>
                        <div class="col-md-8">
                        <div class="form-group">
                                <label>Acción y/o para que sirve</label>
                                <input type="text" class="form-control" name="accion_para_que_sirve" value=" <?php echo $accion_para_que_sirve;?> ">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <select name="dia_entrega" id="" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <select name="mes_entrega" id="" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <select name="año_entrega" id="" class="form-control">
             ...
             ?>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <select name="dia_vencimiento" id="" class="form-control">
                                    ...
                                    <div class="col-md-4">
                                        <select name="año_vencimiento" id="" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="stock_maximo_cajas" value="<?php echo $stock_maximo_cajas;?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                                <label>Stock Maximo/Unidades</label>
                                <input type="text" class="form-control" name="stock_maximo_unidad" value="<?php echo $stock_maximo_unidad;?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                                <label>Stock Minimo/Caja</label>
                                <input type="text" class="form-control" name="stock_minimo_cajas" value="<?php echo $stock_minimo_cajas;?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                        <div class="form-group">
                                <label>Stock Minimo/Unidades</label>
                                <input type="text" class="form-control" name="stock_minimo_unidad" value="<?php echo $stock_minimo_unidad;?>">
                            </div>
                        </div>
                    </div>
